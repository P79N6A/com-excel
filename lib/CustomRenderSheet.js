...
var RowRenderer = function RowRenderer(props) {
  ...
  return _react2.default.createElement(
    ...
    props.length > 1 ? _react2.default.createElement(
      "td",
      { className: "delete-td" },
      props.readonly ? null : _react2.default.createElement(
        "span",
        {
...
var CustomRenderSheet = function (_PureComponent2) {
  ...
  _createClass(CustomRenderSheet, [{
    ...
    value: function componentDidMount() {
      this.state.grid.map(function (a, i) {
        return a.map(function (cell, j) {
    ...
    value: function handleChanges(changes) {
      ...
      this.setState({ grid: grid }, function () {
        _this3.props.saveDdata(_this3.state.grid);
      });
    }
    //增加一行
    ...
    value: function addrow() {
      ...
      this.props.adddata.map(function (item) {
      ...
      this.setState({
        ...
        grid: [].concat(_toConsumableArray(grid), [[].concat(_toConsumableArray(this.props.adddata))])
      }, function () {
        _this4.props.saveDdata(_this4.state.grid);
      });
    }
    ...
    value: function checkDataTypeSelect(i, j) {
      ...
      var oldValue = grid[i][j].value;
      if (Object.keys(grid[i][j]).indexOf("select") > -1 ? true : false) {
        grid[i][j] = { name: "2", value: oldValue, dataEditor: _DataSelect2.default };
      }
    }
  }, {
    key: "delete",
    ...
    value: function renderSheet(props) {
      return _react2.default.createElement(SheetRenderer, _extends({
    ...
    value: function renderRow(props) {
      ...
      return _react2.default.createElement(RowRenderer, _extends({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_DataSheet2.default, {
        data: grid,
