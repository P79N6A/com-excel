...
var DataSheet = function (_PureComponent) {
  ...
  function DataSheet(props) {
    ...
    console.log(_this.prevent, "this.prevent");
    return _this;
  }
  ...
  _createClass(DataSheet, [{
    ...
    value: function onClick(i, j) {
      ...
      this.timer = setTimeout(function () {
        if (!_this5.prevent) {
          console.log("click");
          _this5.props.checktype(i, j);
        }
        _this5.prevent = false;
      }, this.delay);
    }
  }, {
    key: 'onMouseDown',
    value: function onMouseDown(i, j) {
      // console.log( this.props.data,"onMouseDown");
      this.setState({
        spanIndex: i
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          data.map(function (row, i) {
            return _react2.default.createElement(
              RowRenderer,
              { key: keyFn ? keyFn(i) : i, testdelete: _this6.testdelete.bind(_this6), spanIndex: _this6.state.spanIndex, row: i, cells: row },
