...
var RowRenderer = (0, _dragDrop.rowDropTarget)((0, _dragDrop.rowDragSource)(function (props) {
  ...
  return connectDropTarget(connectDragPreview(_react2.default.createElement(
    'tr',
    { className: className },
    connectDragSource(_react2.default.createElement('td', { className: 'cell read-only row-handle', key: '$$actionCell' })),
    children,
...
var CustomRendererSheet = function (_PureComponent2) {
  _inherits(CustomRendererSheet, _PureComponent2);

  function CustomRendererSheet(props) {
    _classCallCheck(this, CustomRendererSheet);

    var _this2 = _possibleConstructorReturn(this, (CustomRendererSheet.__proto__ || Object.getPrototypeOf(CustomRendererSheet)).call(this, props));
  ...
  _createClass(CustomRendererSheet, [{
  ...
  return CustomRendererSheet;
}(_react.PureComponent);

exports.default = CustomRendererSheet;