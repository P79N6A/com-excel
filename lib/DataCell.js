  ...
  _createClass(DataCell, [{
    ...
    value: function handleKey(e) {
      ...
      var _props7 = this.props,
          component = _props7.cell.component,
          forceEdit = _props7.forceEdit;
      // console.log("Datacell",this.props);
    ...
    value: function render() {
      var _props8 = this.props,
          ...
          valueRenderer = _props8.valueRenderer,
          dataEditor = _props8.dataEditor,
          valueViewer = _props8.valueViewer,
          attributesRenderer = _props8.attributesRenderer,
          selected = _props8.selected,
          editing = _props8.editing,
          onKeyUp = _props8.onKeyUp;
      ...
      var className = [cell.className, 'cell', cell.overflow, selected && 'selected', editing && 'editing', cell.readOnly && 'read-only'].filter(function (a) {
        return a;
      }).join(' ');
